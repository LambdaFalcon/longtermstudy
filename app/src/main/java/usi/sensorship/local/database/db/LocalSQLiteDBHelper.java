package usi.sensorship.local.database.db;
...
import usi.sensorship.local.database.tables.AccelerometerTable;
import usi.sensorship.local.database.tables.ActivityRecognitionTable;
import usi.sensorship.local.database.tables.ApplicationLogsTable;
import usi.sensorship.local.database.tables.BlueToothTable;
import usi.sensorship.local.database.tables.EdiaryTable;
import usi.sensorship.local.database.tables.FatigueSurveyTable;
import usi.sensorship.local.database.tables.LectureSurveyTable;
import usi.sensorship.local.database.tables.NotificationsTable;
import usi.sensorship.local.database.tables.OverallSurveyTable;
import usi.sensorship.local.database.tables.PAMSurveyTable;
import usi.sensorship.local.database.tables.PAMTable;
import usi.sensorship.local.database.tables.PSQISurveyTable;
import usi.sensorship.local.database.tables.PSSSurveyTable;
import usi.sensorship.local.database.tables.PersonalitySurveyTable;
import usi.sensorship.local.database.tables.PhoneCallLogTable;
import usi.sensorship.local.database.tables.LocationTable;
import usi.sensorship.local.database.tables.PhoneLockTable;
import usi.sensorship.local.database.tables.ProductivitySurveyTable;
import usi.sensorship.local.database.tables.SMSTable;
import usi.sensorship.local.database.tables.SWLSSurveyTable;
import usi.sensorship.local.database.tables.SimpleMoodTable;
import usi.sensorship.local.database.tables.SleepQualityTable;
import usi.sensorship.local.database.tables.StressSurveyTable;
import usi.sensorship.local.database.tables.UploaderUtilityTable;
import usi.sensorship.local.database.tables.UserTable;
import usi.sensorship.local.database.tables.WeeklySurveyTable;
import usi.sensorship.local.database.tables.WiFiTable;
